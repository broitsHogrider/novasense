...
import ru.novacore.command.MultiNamedCommand;
...
public class ListCommand implements Command, MultiNamedCommand {
    ...
    public void execute(Parameters parameters) {
        logger.log(TextFormatting.RED + "advice" + TextFormatting.DARK_GRAY + " / " + TextFormatting.GRAY + "Помогает узнать как использовать команду");

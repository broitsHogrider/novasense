...
@FunctionInfo(name = "TargetStrafe", category = Category.Movement)
public class TargetStrafe extends Function {
    ...
    public TargetStrafe(AttackAura attackAura) {
    ...
    private LivingEntity getTarget() {
        return attackAura.isState() ? attackAura.getTarget() : null;
    }
    ...
    private boolean shouldSaveTarget(LivingEntity target) {
        ...
        return settingIsEnabled && targetAndTargetNameExist && attackAura.isState();
    }

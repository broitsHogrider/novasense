...
public class Main {
    ...
    public static void main(String[] p_main_0_) throws IOException {
        ...
        OptionSpec<String> optionspec10 = optionparser.accepts("username").withRequiredArg().defaultsTo("zero");
        ...
        OptionSpec<String> key = optionparser.accepts("key").withRequiredArg();
        ...
        Thread thread = new Thread("Client Shutdown Thread") {
            public void run() {
                if (NovaCore.getInstance().playerOnServer) {
                    try {
                    ...
                    NovaCore.getInstance().playerOnServer = false;
                }

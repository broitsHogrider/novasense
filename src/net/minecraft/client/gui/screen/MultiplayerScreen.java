...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = NovaCore.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(NovaCore.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        NovaCore.getInstance().getViaMCP().viaScreen.tick();

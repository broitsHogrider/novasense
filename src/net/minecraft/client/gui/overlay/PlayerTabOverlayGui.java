...
public class PlayerTabOverlayGui extends AbstractGui {
     ...
     * however.
     */
    private Animation animation = new Animation().setToValue(1);
    ...
    public void setVisible(boolean visible) {
        ...
        //animation.animate(visible ? 1 : 0, 0.3, visible ? Easings.BACK_OUT : Easings.BACK_IN, true);
    }
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        //MathUtil.scaleStart(mc.getMainWindow().getScaledWidth() / 2F, 10, animation.getValue());
        ...
        for (int i5 = 0; i5 < i4; ++i5) {
            ...
            if (i5 < list.size()) {
                ...
                if (isBetter) {
                    ...
                    float textWidth = Fonts.interMedium.getWidth(String.valueOf(ping), 6);
                    ...
                    Fonts.interMedium.drawTextWithOutline(p_238523_1_, String.valueOf(ping), i1 + k2 - (flag ? 9 : 0) - textWidth - 2, l2 + 1.5f, color, 6, 0.05f);
                } else {
